---
title: Teacher Unions and Test Scores
author: R package build
date: '2021-05-17'
slug: unionization-and-naep-data
categories: [data-exploration]
tags: []
description: 'Explore state-level teacher unionization rates and student math/reading performance'
---
```{r include = FALSE}
...
Based on the graph, there may be a correlation between NAEP  reading scores and unionization although again.   Of course,  we know that correlation is not causation!      
Even the correlation between the two variables may be suspect. You could argue that if we remove Massachusetts and the trend line, the positive relationship would not be so apparent.  Massachusetts has traditionally been the state with highest test scores, and it also happens to have a high unionization rate.  These two variables either could be coincidental or related to a third variable. 
...
The coefficient of unionization is statistically significant.  Once more, this evidence is just correlational, so we shouldn't read too much into it. 
...
Furthermore, the relationship between math and reading NAEP scores was statistically significant.
...
3. It is often useful to explore a common construct on more than one dimension.  The reading over math scatterplots helped us to simultaneously look at two dimensions of student performance.
